        ...
        <header className="py-4 px-2">
            <div className="header-container flex items-center justify-between">
                ...
                <div className="header-buttons  flex gap-4 text-2xl">
                    ...
                    <button
                        className="toggle-nav z-20 md:hidden"
                        onClick={toggle_nav}
                    >
                        {is_nav_open ? (
                    ...
                    <nav className="hidden md:flex text-xl ml-2">
                ...
                {is_nav_open && (
                    <nav className="mobile-nav absolute bg-white bg-opacity-50 backdrop-blur-sm left-0 top-0 w-full min-h-screen flex items-center justify-center">
